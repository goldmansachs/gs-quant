...
# Generate function doc pages automatically
...
# a subclass of Sphinx’s HTMLTranslator, that is used to translate document
# trees to HTML. Default is None (use the builtin translator).
#
html_translator_class = './_writers/html5'
...
mathjax_path = '/resources/mathjax/latest.js?config=TeX-AMS-MML_HTMLorMML'

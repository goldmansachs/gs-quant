  ...
  - 📁 00_instruments_and_measures
    - 📁 examples
      - 📁 00_instrument_basics
        - 📄 [1_view-trade-properties.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/00_instrument_basics/1_view-trade-properties.ipynb)
        - 📄 [2_get-a-property.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/00_instrument_basics/2_get-a-property.ipynb)
        - 📄 [3_set-a-property.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/00_instrument_basics/3_set-a-property.ipynb)
        - 📄 [4_enum-property.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/00_instrument_basics/4_enum-property.ipynb)
        - 📄 [5_resolve-a-trade.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/00_instrument_basics/5_resolve-a-trade.ipynb)
        - 📄 [6_market-data.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/00_instrument_basics/6_market-data.ipynb)
        - 📄 [7_float-with-info.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/00_instrument_basics/7_float-with-info.ipynb)
      - 📁 01_rates
        ...
        - 📄 [5_calc_swap_price_in_pricing_context.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/01_rates/5_calc_swap_price_in_pricing_context.ipynb)
        - 📄 [6_calc_swap_price_historically.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/01_rates/6_calc_swap_price_historically.ipynb)
        - 📄 [7_calc_swap_risks_in_pricing_context.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/01_rates/7_calc_swap_risks_in_pricing_context.ipynb)
        - 📄 [8_calc_swap_risk_historically.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/01_rates/8_calc_swap_risk_historically.ipynb)
        - 📄 [9_swaption_trade_construction.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/01_rates/9_swaption_trade_construction.ipynb)
      - 📁 02_fx
        - 📄 [1_fx_fwd_trade_construction.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/1_fx_fwd_trade_construction.ipynb)
        - 📄 [2_fx_option_trade_construction.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/2_fx_option_trade_construction.ipynb)
        - 📄 [3_fx_vol_swap_trade_construction.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/3_fx_vol_swap_trade_construction.ipynb)
        - 📄 [4_fx_binary_trade_construction.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/4_fx_binary_trade_construction.ipynb)
        - 📄 [5_calc_option_measures.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/5_calc_option_measures.ipynb)
        - 📄 [6_fx_var_swap_trade_construction.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/6_fx_var_swap_trade_construction.ipynb)
        - 📄 [7_fx_knockout_trade_construction.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/7_fx_knockout_trade_construction.ipynb)
        - 📄 [8_fx_double_touch_trade_construction.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/8_fx_double_touch_trade_construction.ipynb)
        - 📄 [9_fx_delta_measures.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/02_fx/9_fx_delta_measures.ipynb)
      - 📁 03_eq
        - 📄 [1_calc_eq_option_price.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/03_eq/1_calc_eq_option_price.ipynb)
        - 📄 [2_calc_eq_option_risk_measures.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/03_eq/2_calc_eq_option_risk_measures.ipynb)
        - 📄 [3_calc_eq_option_price_and_risk_in_pricing_context.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/03_eq/3_calc_eq_option_price_and_risk_in_pricing_context.ipynb)
        - 📄 [4_calc_eq_option_price_and_risk_historically.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/03_eq/4_calc_eq_option_price_and_risk_historically.ipynb)
        - 📄 [5_calc_eq_option_portfolio_greeks.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/03_eq/5_calc_eq_option_portfolio_greeks.ipynb)
      - 📁 04_credit
        - 📄 [1_cdindex_option_price.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/04_credit/1_cdindex_option_price.ipynb)
        - 📄 [2_cdindex_option_xover_payer_spread.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/04_credit/2_cdindex_option_xover_payer_spread.ipynb)
        - 📄 [3_cdindex_option_risks.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/04_credit/3_cdindex_option_risks.ipynb)
        - 📄 [4_cdindex_price.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/04_credit/4_cdindex_price.ipynb)
        - 📄 [5_cdindex_roll_price.ipynb](02_pricing_and_risk/00_instruments_and_measures/examples/04_credit/5_cdindex_roll_price.ipynb)
    - 📁 tutorials

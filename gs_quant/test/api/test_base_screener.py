...
def test_get_all_screeners(mocker):
    rows = (ScreenerRow(entity_id='MA33ZVRPT84HRK5A', entity_type='index', universe=True, expand=True),)
    ...
    mock_response = {'totalResults': 2, 'results': (screener1, screener2)}
...
def test_publish_to_screener(mocker):
    screener_id = 'id'
    publish_data = {'rows': [{"Name": "Obalon Therapeutics Inc", "Entity ID": "ABDFDSCD"}]}

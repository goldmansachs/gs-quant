...
from gs_quant.target.data import DataQuery, DataSetEntity, DataSetFieldEntity, FieldFilterMapDataQuery, MarketDataVendor
...
def test_get_many_coordinates(mocker):
    coordinates = [{'id': 'MC123', 'name': 'A_B_C_D_E.F1'}, {'id': 'MC123', 'name': 'A_B_C_D_E.F2'}]
    mocker.patch.object(
        GsSession.__class__, 'default_value', return_value=GsSession.get(Environment.QA, 'client_id', 'secret')
    )
        ...
        "results": [
            {
                ...
                "parameters": {"enum": ["spot", "forward", "normalized", "delta"]},
                "entitlements": {
                    "view": ["internal", "role:DataServiceAdmin", "external", "guid:8b4e2021fd12429885b30f6074037087"],
                    "edit": ["role:DataServiceAdmin", "guid:8b4e2021fd12429885b30f6074037087"],
                    "admin": ["role:DataServiceAdmin"],
                },
                "metadata": {
            ...
            },
            {
                ...
                "parameters": {},
                "entitlements": {
                    "view": ["internal", "role:DataServiceAdmin", "external"],
                    "edit": ["role:DataServiceAdmin"],
                    "admin": ["role:DataServiceAdmin"],
                },
                "metadata": {
                    "createdById": "8b4e2021fd12429885b30f6074037087",
...
def test_get_field_types(mocker):
    mock_response = {
        ...
        "results": [
            ...
            DataSetFieldEntity(
                name="adjDate", type_="string", field_java_type='DateField', parameters=DictBase({'format': 'date'})
            ),
            DataSetFieldEntity(
                name="time",
                type_="string",
                field_java_type='DateTimeField',
                parameters=DictBase({'format': 'date-time'}),
            ),
        ],
    }

    mock_field_types = {"price": "number", "strikeReference": "string", "adjDate": "date", "time": "date-time"}

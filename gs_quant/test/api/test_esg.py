        ...
        'bottomTenRanked': [
            {
                'measure': 'gPercentile',
                'results': [
                    {'assetId': 'MA4B66MW5E27UAHKG34', 'name': 'The Goldman Sachs Group, Inc.', 'value': 97.57}
                ],
            },
            {
                'measure': 'esDisclosurePercentage',
                'results': [
                    {'assetId': 'MA4B66MW5E27UAHKG34', 'name': 'The Goldman Sachs Group, Inc.', 'value': 83.33}
                ],
            },
        ],
        'noESGData': {
            'gross': {'weight': 0.0, 'assets': []},
            'long': {'weight': 0.0, 'assets': []},
            'short': {'weight': 0.0, 'assets': []},
            'benchmark': {
                'weight': 2.5402270308391683,
                'assets': [
                    {'assetId': 'MA4B66MW5E27UALNB96', 'name': 'News Corp - Class B', 'weight': 0.026140889953506573},
                    {
                        'assetId': 'MA4B66MW5E27UANLXX3',
                        'name': 'Under Armour Inc-Class C',
                        'weight': 0.02019587639265163,
                    },
                    {'assetId': 'MA4B66MW5E27UAGYZ49', 'name': 'Alphabet Inc-CL C', 'weight': 2.4141476728491242},
                    {'assetId': 'MA4B66MW5E27UAE4MGB', 'name': 'Discovery Inc-C', 'weight': 0.03970496421509619},
                    {'assetId': 'MA4B66MW5E27UAGEHL4', 'name': 'Fox Corp - Class A', 'weight': 0.040037627428790246},
                ],
            },
        },
    }

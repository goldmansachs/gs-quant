...
def test_build_market_data_query():
    ...
    with DataContext(start=dt.date(2013, 1, 1), end=dt.date(2020, 2, 1)):
        queries = GsDataApi.build_market_data_query(
            asset_ids, query_type, where, source, real_time, measure, parallelize_queries=True
        )
        payload = {
            'entityIds': ['MA4B66MW5E27U8P3295'],
        ...
        dates = [
            {'startDate': dt.date(2013, 1, 1), 'endDate': dt.date(2014, 1, 1)},

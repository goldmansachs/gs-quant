...
esg_data = {
    ...
    'quintiles': [
        {
            ...
            'results': [
                ...
                {'name': 'Q2', 'description': '<=60-80%', 'gross': 0, 'long': 0, 'short': 0},
                {'name': 'Q3', 'description': '<=40-60%', 'gross': 0, 'long': 0, 'short': 0},
                {
                    'name': 'Q4',
                    'description': '<=20-40%',
                ...
                {'name': 'Q5', 'description': '<=0-20%', 'gross': 0, 'long': 0, 'short': 0},
                {
                    'name': 'Not Included',
    ...
    'weightsBySector': [
        {'name': 'Diversified Financials', 'gross': 91.03557560284325, 'long': 91.03557560284325, 'short': 0},
        {'name': 'Automobile Manufacturers', 'gross': 8.955474904385047, 'long': 0, 'short': 8.955474904385047},
        {'name': 'Total', 'gross': 99.99105050722832, 'long': 91.03557560284325, 'short': 8.955474904385047},
        {'name': 'Not Included', 'gross': 0.008949492771697426, 'long': 0.008949492771697426, 'short': 0},
    ],
    'measuresBySector': [
        {
            'measure': 'gPercentile',
            'results': [
                {'name': 'Diversified Financials', 'gross': 97.39, 'long': 97.39, 'short': 0},
                {'name': 'Automobile Manufacturers', 'gross': 34.02, 'long': 0, 'short': 34.02},
                {'name': 'Total', 'gross': 91.71440761636107, 'long': 97.39, 'short': 34.02},
            ],
        }
    ],
    'weightsByRegion': [
        {'name': 'N. America', 'gross': 99.99105050722832, 'long': 91.03557560284325, 'short': 8.955474904385047},
        {'name': 'Total', 'gross': 99.99105050722832, 'long': 91.03557560284325, 'short': 8.955474904385047},
        {'name': 'Not Included', 'gross': 0.008949492771697426, 'long': 0.008949492771697426, 'short': 0},
    ],
    'measuresByRegion': [
        {
            'measure': 'gPercentile',
            'results': [
                {'name': 'N. America', 'gross': 91.71440761636107, 'long': 97.39, 'short': 34.02},
                {'name': 'Total', 'gross': 91.71440761636107, 'long': 97.39, 'short': 34.02},
            ],
        }
    ],
    'topTenRanked': [
        {
            'measure': 'gPercentile',
            'results': [
                {'assetId': 'MA4B66MW5E27UAHKG34', 'name': 'The Goldman Sachs Group, Inc.', 'value': 97.39},
                {'assetId': 'MA4B66MW5E27UANEQ6R', 'name': 'Tesla Inc', 'value': 34.02},
            ],
        }
    ],
    'bottomTenRanked': [
    ...
    'noESGData': {
        'gross': {
            ...
            'assets': [{'assetId': 'MA4B66MW5E27UAL9SX6', 'name': 'Mustek LTD', 'weight': 0.008949492771697426}],
        },
        'long': {
            'weight': 0.008949492771697426,
            'assets': [{'assetId': 'MA4B66MW5E27UAL9SX6', 'name': 'Mustek LTD', 'weight': 0.008949492771697426}],
        },
        'short': {'weight': 0.0, 'assets': []},
    },
}
carbon_data = {
    "coverage": {
        ...
        "numberOfCompanies": {
            "portfolio": {
                "totalGHG": {"reportedVerified": 50, "reportedUnverified": 50, "estimated": 0, "missing": 0},
                "scope1": {"reportedVerified": 50, "reportedUnverified": 50, "estimated": 0, "missing": 0},
                "scope2": {"reportedVerified": 50, "reportedUnverified": 50, "estimated": 0, "missing": 0},
            },
            "benchmark": {
                "totalGHG": {"reportedVerified": 50, "reportedUnverified": 50, "estimated": 0, "missing": 0},
                "scope1": {"reportedVerified": 50, "reportedUnverified": 50, "estimated": 0, "missing": 0},
    ...
    "sbtiAndNetZeroTargets": {
        "capitalAllocated": {
            "scienceBasedTarget": {
                "portfolio": {"targetsSet": 0, "targetsNotSet": 0, "missing": 100},
                "benchmark": {"targetsSet": 0, "targetsNotSet": 0, "missing": 100},
            },
        ...
        "portfolioEmissions": {
            "scienceBasedTarget": {
                "portfolio": {"targetsSet": 0, "targetsNotSet": 0, "missing": 99.99999999999997},
                "benchmark": {"targetsSet": 0, "targetsNotSet": 0, "missing": 99.99999999999997},
            },
            "netZeroEmissionsTarget": {
                "portfolio": {"targetsSet": 0, "targetsNotSet": 0, "missing": 99.99999999999997},
                "benchmark": {"targetsSet": 0, "targetsNotSet": 0, "missing": 99.99999999999997},
        ...
        "totalGHG": {
            "portfolio": {
                "gicsSector": [
                    ...
                    {"name": "Financials", "portfolioEmissions": 0.010373176342882682, "capitalAllocated": 37813},
                ],
                "gicsIndustry": [
                    {
                ...
                "region": [{"name": "Americas", "portfolioEmissions": 0.016784770256626273, "capitalAllocated": 52107}],
            },
            "benchmark": {
                "gicsSector": [
                    {
        ...
        "scope1": {
            "portfolio": {
                "gicsSector": [
                    ...
                    {"name": "Financials", "portfolioEmissions": 0.0006469796544212892, "capitalAllocated": 37813},
                ],
                "gicsIndustry": [
                    {
                        "name": "Technology Hardware & Equipment",
                ...
                "region": [
                    {"name": "Americas", "portfolioEmissions": 0.0009713787667226322, "capitalAllocated": 52107}
                ],
            },
            "benchmark": {
                "gicsSector": [
        ...
        "scope2": {
            "portfolio": {
                "gicsSector": [
                    ...
                    {"name": "Financials", "portfolioEmissions": 0.009726196688461392, "capitalAllocated": 37813},
                ],
                "gicsIndustry": [
                    {
                        "name": "Technology Hardware & Equipment",
                ...
                "region": [{"name": "Americas", "portfolioEmissions": 0.015813391489903638, "capitalAllocated": 52107}],
            },
            "benchmark": {
                "gicsSector": [
                    {
    ...
    "results": [
        {
            ...
            "bySectorAggregations": [
                {
                    ...
                    "estimatedPnl": -10570.100235985032,
                    "industries": [
                        {"name": "Software", "exposure": -5917600, "estimatedPnl": -3047.0113322484867},
                        {
            ...
            "byRegionAggregations": [
                {"name": "United States", "exposure": -2882560, "estimatedPnl": -10570.100235985032}
            ],
            "byDirectionAggregations": [
                {"name": "LONG", "exposure": 3035040, "estimatedPnl": -7523.088903736546},
                {"name": "SHORT", "exposure": -5917600, "estimatedPnl": -3047.0113322484867},
            ],
            "byAsset": [
                {
                    "assetId": "MA4B66MW5E27U9VBB94",
...
def test_get_reports(mocker):
        ...
        Report.from_dict(
            {
                ...
                'parameters': {'riskModel': 'AXUS4M', 'transactionCostModel': 'FIXED'},
                'percentageComplete': 0,
                'status': 'new',
            }
        ),
    ...
    mocker.patch.object(GsPortfolioApi, 'get_portfolio', return_value=mock_portfolio)
    mocker.patch.object(GsPortfolioApi, 'get_position_dates', return_value=[dt.date(2020, 1, 1)])
    mocker.patch.object(GsPortfolioApi, 'get_positions_for_date', return_value=None)
    mocker.patch.object(GsPortfolioApi, 'get_reports', return_value=mock_reports)
...
def test_set_entitlements(mocker):
    ...
    entitlements = Entitlements(
        view=EntitlementBlock(
            users=[User(user_id='fakeId', name='Fake User', email='fake@gs.com', company='Goldman Sachs')]
        )
    )

    mocker.patch.object(GsSession, '_get', return_value=mock_portfolio)
    mocker.patch.object(
        GsPortfolioApi,
        'get_position_dates',
...
def test_run_reports(mocker):
    ...
    mocker.patch.object(GsPortfolioApi, 'get_positions_for_date', return_value=None)
    mocker.patch.object(GsPortfolioApi, 'get_reports', return_value=mock_reports)
    mocker.patch.object(GsReportApi, 'get_report_jobs', return_value=mock_report_jobs)
    mocker.patch.object(GsReportApi, 'get_report_job', return_value=mock_report_job)
    mocker.patch.object(GsReportApi, 'get_factor_risk_report_results', return_value=mock_results)
...
def test_batched_schedule_reports(mocker):
    mocker.patch.object(
        GsPortfolioApi,
        'get_position_dates',
        return_value=[dt.date(2022, 2, 1), dt.date(2022, 8, 1), dt.date(2022, 10, 1), dt.date(2022, 11, 1)],
    )
    ...
    pm.schedule_reports(
        start_date=dt.date(2022, 2, 1), end_date=dt.date(2022, 11, 10), backcast=False, months_per_batch=2
    )
    ...
    pm.schedule_reports(
        start_date=dt.date(2022, 2, 1), end_date=dt.date(2022, 11, 10), backcast=False, months_per_batch=4
    )
...
def test_batched_schedule_reports_wo_dates(mocker):
    ...
    mocker.patch.object(GsPortfolioApi, 'get_schedule_dates', return_value=[dt.date(2022, 2, 1), dt.date(2022, 11, 10)])
...
def test_batched_schedule_validations(mocker):
    ...
    mocker.patch.object(GsPortfolioApi, 'get_schedule_dates', return_value=[dt.date(2022, 2, 1), dt.date(2022, 11, 5)])
...
def test_esg_summary(mocker):
    mocker.patch.object(GsEsgApi, 'get_esg', return_value=esg_data)
...
def test_carbon_coverage(mocker):
    ...
    assert coverage.to_dict() == carbon_data.get(CarbonCard.COVERAGE.value).get(
        CarbonCoverageCategory.NUMBER_OF_COMPANIES.value
...
def test_carbon_sbti_netzero_coverage(mocker):
    ...
    ).get(CarbonTargetCoverageCategory.CAPITAL_ALLOCATED.value).get('scienceBasedTarget').get(
...
def test_carbon_emissions_allocation(mocker):
    ...
    assert emissions.rename(columns={CarbonEmissionsAllocationCategory.GICS_INDUSTRY.value: 'name'}).to_dict(
        'records'
    ) == carbon_data.get(CarbonCard.ALLOCATIONS.value).get(CarbonScope.TOTAL_GHG.value).get(
        CarbonEntityType.PORTFOLIO.value
    ).get(CarbonEmissionsAllocationCategory.GICS_INDUSTRY.value)
...
def test_carbon_attribution_table(mocker):
    ...
    pm = PortfolioManager('MP')
    attribution = pm.get_carbon_attribution_table(
        benchmark_id='MA', scope=CarbonScope.SCOPE2, intensity_metric=CarbonEmissionsIntensityType.EI_REVENUE
    )
...
def test_get_macro_exposure(mocker):
    portfolio_constituents = {
        "date": ["2022-05-02", "2022-05-02"],
        "assetId": ["mq1", "mq2"],
        "direction": ["LONG", "LONG"],
        "netExposure": [1000, 1000],
    }
    assets_data = [{"id": "mq1", "name": "asset1", "gsid": "1"}, {"id": "mq2", "name": "asset2", "gsid": "2"}]
    factor_sens = {
        "factor1": {("1", "2022-05-02"): 1, ("2", "2022-05-02"): 1},
        "factor2": {("1", "2022-05-02"): 5, ("2", "2022-05-02"): 5},
    }
    factor_data = {
        "identifier": ["15", "17"],
    ...
    result = {
        ("Asset Information", "Asset Name"): {"1": "asset1", "2": "asset2", "Total Factor Exposure": np.nan},
    ...
    macro_model = MacroRiskModel(
        id_="fake_macro_model",
        name="fake_model",
    ...
    mocker.patch.object(
        fake_ppa, "get_portfolio_constituents", return_value=pd.DataFrame.from_dict(portfolio_constituents)
    )
    ...
    mocker.patch.object(macro_model, "get_universe_sensitivity", return_value=pd.DataFrame.from_dict(factor_sens))
...
def test_get_factor_scenario_analytics(mocker):
    risk_report = FactorRiskReport(report_id='id', risk_model='RISK_MODEL')
    ...
    factor_scenario = FactorScenario(
        ...
        parameters=HistoricalSimulationParameters(start_date=dt.date(2016, 1, 1), end_date=dt.date(2020, 1, 1)),
    )
    ...
    assert (
        len(
            set(scenario_analytics_data.keys())
            - {
                "summary",
                "factorPnl",
                "bySectorAggregations",
    ...
    for key, value in scenario_analytics_data.items():
        ...
        result_df.columns = result_df.columns.map(
            lambda x: {

...
custom_aum = {
    'data': [
        ...
        {'date': '2023-06-02', 'aum': 100},
        {'date': '2023-06-05', 'aum': 100},
        {'date': '2023-06-06', 'aum': 100},
    ]
}

ppa_data = [
    {'date': "2023-06-01", 'reportId': "PPAID", 'netExposure': 2414214.74},
    {'date': "2023-06-02", 'reportId': "PPAID", 'netExposure': 2414214.74},
    {'date': "2023-06-05", 'reportId': "PPAID", 'netExposure': 2414214.74},
    {'date': "2023-06-06", 'reportId': "PPAID", 'netExposure': 2414214.74},
    {'date': "2023-06-07", 'reportId': "PPAID", 'netExposure': 2414214.74},
]
...
def test_get_factor_risk_report(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=Report(
            ...
            position_source_type=PositionSourceType.Portfolio,
            position_source_id='PORTFOLIOID',
            parameters=ReportParameters(risk_model='AXUS4M', fx_hedged=True),

        ...
        'constituents': [
            {
                ...
                'marginalCost': 0.09597615517006632,
                'advPercentage': 0,
                'notional': 3819.9199999999996,
                'price': 146.92,
                'weight': 0.08040829746809594,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'sector': 'Materials',
                'shares': -2.9210200815542167,
                'assetId': 'MA4B66MW5E27U9XPVYM',
                'bbid': 'ALB UN',
                'currency': 'USD',
                'industry': 'Chemicals',
                'marginalCost': 0.078815239121909,
                'advPercentage': 2e-06,
                'notional': -661.3189464638747,
                'price': 226.4,
                'weight': -0.01392058749098281,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'marginalCost': 0.0010543794559583631,
                'advPercentage': 0,
                'notional': -85.91019061906543,
                'price': 105.8,
                'weight': -0.0018083866056981923,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
            ...
            },
            {
                ...
                'sector': 'Financials',
                'shares': -27.227187182634943,
                'assetId': 'MA4B66MW5E27UA4ZCWT',
                'bbid': 'C UN',
                'currency': 'USD',
                'industry': 'Banks',
                'marginalCost': 0.05919571023849292,
                'advPercentage': 2e-06,
                'notional': -1938.0311836599553,
                'price': 71.18,
                'weight': -0.040795039665274604,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                'name': 'Cummins Inc',
                'transactionCost': 3.3661617040634155,
                'sector': 'Industrials',
                'shares': -0.4130028393296445,
                'assetId': 'MA4B66MW5E27UACX6RZ',
                'bbid': 'CMI UN',
                'currency': 'USD',
                'industry': 'Machinery',
                'marginalCost': 0.006662256400232119,
                'advPercentage': 0,
                'notional': -94.02422640178686,
                'price': 227.66,
                'weight': -0.0019791848954225427,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
            ...
            },
            {
                ...
                'sector': 'Real Estate',
                'shares': -8.864060939026558,
                'assetId': 'MA4B66MW5E27UAEP46J',
                'bbid': 'DRE UN',
                'currency': 'USD',
                'industry': 'Equity Real Estate Investment Trusts (REITs)',
                'marginalCost': 0.012421166613716166,
                'advPercentage': 5e-06,
                'notional': -433.0093768714474,
                'price': 48.85,
                'weight': -0.009114731926834648,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                'name': 'Davita Inc',
                'transactionCost': 3.084942579269409,
                'sector': 'Health Care',
                'shares': -3.4880239796169494,
                'assetId': 'MA4B66MW5E27UAEP4D8',
                'bbid': 'DVA UN',
                'currency': 'USD',
                'industry': 'Health Care Providers & Services',
                'marginalCost': 0.027406811709718284,
                'advPercentage': 6e-06,
                'notional': -422.05090153365086,
                'price': 121,
            ...
            },
            {
                ...
                'sector': 'Real Estate',
                'shares': -3.1030213327842304,
                'assetId': 'MA4B66MW5E27UAFU2CS',
                'bbid': 'EXR UN',
                'currency': 'USD',
                'industry': 'Equity Real Estate Investment Trusts (REITs)',
                'marginalCost': 0.04508686837043359,
                'advPercentage': 5e-06,
                'notional': -535.6125122518861,
                'price': 172.61,
                'weight': -0.011274500568803494,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
            ...
            },
            {
                ...
                'marginalCost': 1.3508400095029636,
                'advPercentage': 2.3e-05,
                'notional': 19933.350000000002,
                'price': 390.85,
                'weight': 0.4195917025319039,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'shares': -11.239077266890737,
                'assetId': 'MA4B66MW5E27UAJ5XEZ',
                'bbid': 'HRL UN',
                'currency': 'USD',
                'industry': 'Food Products',
                'marginalCost': 0.013853571784092618,
                'advPercentage': 4e-06,
                'notional': -458.55435248914205,
                'price': 40.8,
            ...
            },
            {
                ...
                'assetId': 'MA4B66MW5E27UAJQF4M',
                'bbid': 'IRM UN',
                'currency': 'USD',
                'industry': 'Equity Real Estate Investment Trusts (REITs)',
                'marginalCost': 0.011447654789702045,
                'advPercentage': 3e-06,
                'notional': -224.93741640940388,
                'price': 44.27,
                'weight': -0.004734872638786235,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'sector': 'Financials',
                'shares': -12.604086651115832,
                'assetId': 'MA4B66MW5E27UAKHZFD',
                'bbid': 'JPM UN',
                'currency': 'USD',
                'industry': 'Banks',
                'marginalCost': 0.054444447777798256,
                'advPercentage': 1e-06,
                'notional': -2054.970287597925,
                'price': 163.04,
                'weight': -0.043256576622880225,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                'name': 'Kroger Co',
                'transactionCost': 1.2731897830963135,
                'sector': 'Consumer Staples',
                'shares': -1.730011893560012,
                'assetId': 'MA4B66MW5E27UAKNZNV',
                'bbid': 'KR UN',
                'currency': 'USD',
                'industry': 'Food & Staples Retailing',
                'marginalCost': 0.0018536665905637035,
                'advPercentage': 0,
                'notional': -69.16587550452927,
                'price': 39.98,
            ...
            },
            {
                ...
                'sector': 'Materials',
                'shares': -5.192035694429817,
                'assetId': 'MA4B66MW5E27UAL9SLW',
                'bbid': 'MOS UN',
                'currency': 'USD',
                'industry': 'Chemicals',
                'marginalCost': 0.008339681547933048,
                'advPercentage': 2e-06,
                'notional': -186.18640000225324,
                'price': 35.86,
                'weight': -0.003919174075869411,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'sector': 'Financials',
                'shares': -100.16368860962515,
                'assetId': 'MA4B66MW5E27UAL9STW',
                'bbid': 'MS UN',
                'currency': 'USD',
                'industry': 'Capital Markets',
                'marginalCost': 0.5160781640859926,
                'advPercentage': 1.6e-05,
                'notional': -10307.845194816524,
                'price': 102.91,
                'weight': -0.2169773928982519,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                'name': 'MSCI Inc',
                'transactionCost': 7.908167362213135,
                'sector': 'Financials',
                'shares': -0.5740039461869635,
                'assetId': 'MA4B66MW5E27UAL9SUH',
                'bbid': 'MSCI UN',
                'currency': 'USD',
                'industry': 'Capital Markets',
                'marginalCost': 0.06319486932947428,
                'advPercentage': 2e-06,
                'notional': -379.628989889672,
                'price': 661.37,
                'weight': -0.007991089014053052,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                'name': 'Nucor Corp',
                'transactionCost': 3.182479500770569,
                'sector': 'Materials',
                'shares': -0.7970054792874738,
                'assetId': 'MA4B66MW5E27UALNB48',
                'bbid': 'NUE UN',
                'currency': 'USD',
                'industry': 'Metals & Mining',
                'marginalCost': 0.005388287534627193,
                'advPercentage': 0,
                'notional': -80.43379296969185,
                'price': 100.92,
                'weight': -0.001693109895388968,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
            ...
            },
            {
                ...
                'assetId': 'MA4B66MW5E27UAM94Q4',
                'bbid': 'QCOM UW',
                'currency': 'USD',
                'industry': 'Semiconductors & Semiconductor Equipment',
                'marginalCost': 0.001836148888424059,
                'advPercentage': 0,
                'notional': -83.67557525643583,
                'price': 133.88,
                'weight': -0.0017613485481459143,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
            ...
            },
            {
                'country': 'United States',
                'name': 'Twitter Inc',
                'transactionCost': 1.2658634781837463,
                'sector': 'Communication Services',
                'shares': -8.874061007775461,
                'assetId': 'MA4B66MW5E27UANLXU9',
                'bbid': 'TWTR UN',
                'currency': 'USD',
                'industry': 'Interactive Media & Services',
                'marginalCost': 0.015894775099317016,
                'advPercentage': 1e-06,
                'notional': -596.5143809426665,
                'price': 67.22,
                'weight': -0.012556468666054534,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'sector': 'Financials',
                'shares': -43.79430107894055,
                'assetId': 'MA4B66MW5E27UANT8X5',
                'bbid': 'WFC UN',
                'currency': 'USD',
                'industry': 'Banks',
                'marginalCost': 0.061059807755110544,
                'advPercentage': 2e-06,
                'notional': -2098.622907702831,
                'price': 47.92,
                'weight': -0.044175452636686034,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'sector': 'Health Care',
                'shares': -5.308036491917078,
                'assetId': 'MA4B66MW5E27UANZH4M',
                'bbid': 'XRAY UW',
                'currency': 'USD',
                'industry': 'Health Care Equipment & Supplies',
                'marginalCost': 0.01947929477213156,
                'advPercentage': 5e-06,
                'notional': -318.5352698799438,
                'price': 60.01,
            ...
            },
            {
                ...
                'currency': 'USD',
                'industry': 'Interactive Media & Services',
                'marginalCost': 0.004364390584540722,
                'advPercentage': 0,
                'notional': -251.6622101381627,
                'price': 352.96,
                'weight': -0.005297422420958517,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                'name': 'Tapestry Inc',
                'transactionCost': 2.314427137374878,
                'sector': 'Consumer Discretionary',
                'shares': -7.397050853562664,
                'assetId': 'MAAHJ4JYCKZ6P025',
                'bbid': 'TPR UN',
                'currency': 'USD',
                'industry': 'Textiles, Apparel & Luxury Goods',
                'marginalCost': 0.014220203034272804,
                'advPercentage': 2e-06,
                'notional': -291.88762668158273,
                'price': 39.46,
                'weight': -0.006144156713614223,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'sector': 'Communication Services',
                'shares': -11.81608123370237,
                'assetId': 'MAQQM1QHGJDFAVKN',
                'bbid': 'LUMN UN',
                'currency': 'USD',
                'industry': 'Diversified Telecommunication Services',
                'marginalCost': 0.012712411491036973,
                'advPercentage': 1e-06,
                'notional': -152.78193035177165,
                'price': 12.93,
                'weight': -0.003216018896593429,
                'borrowCost': 40,
            },
        ],
        'transactionCost': 2.5770571473071144,
    },
    'hedge': {
        'transactionCost': 2.2604819652681694,
        'correlation': 0.936758446681233,
        'backtestPerformance': [
            ['2020-09-24', 1],
            ['2020-09-25', 1.0104116399850593],
            ['2020-09-28', 1.0307855197014755],
            ['2020-09-29', 1.0163931905275039],
            ['2020-09-30', 1.0303780678487708],
            ['2020-10-01', 1.02803072573049],
            ...
            ['2020-10-28', 1.013939716813292],
            ['2020-10-29', 1.025285647916773],
            ...
            ['2020-12-17', 1.283302631746248],
            ['2020-12-18', 1.276354699607117],
            ...
            ['2021-01-15', 1.409001702900938],
            ['2021-01-18', 1.409001702900938],
            ...
            ['2021-02-02', 1.370111970146903],
            ['2021-02-03', 1.369846444923827],
            ...
            ['2021-02-24', 1.511687900368849],
            ['2021-02-25', 1.486336535951723],
            ...
            ['2021-04-22', 1.5350915789121093],
            ['2021-04-23', 1.57158539249219],
            ...
            ['2021-05-31', 1.6828566766917903],
            ['2021-06-01', 1.69991088376666],
            ...
            ['2021-08-03', 1.7212246073309094],
            ['2021-08-04', 1.71284744352946],
            ...
            ['2021-08-12', 1.8211088797799007],
            ['2021-08-13', 1.80763324042271],
            ['2021-08-16', 1.7990148335838823],
            ['2021-08-17', 1.7821201492173437],
            ['2021-08-18', 1.7595999866259955],
            ['2021-08-19', 1.7402030612253945],
            ['2021-08-20', 1.75394804825027],
            ['2021-08-23', 1.774564369295308],
            ['2021-08-24', 1.791036747026845],
            ...
            ['2021-09-09', 1.782974909163946],
            ['2021-09-10', 1.774210004132321],
            ['2021-09-13', 1.7863371703894837],
            ['2021-09-14', 1.7607086022595286],
            ['2021-09-15', 1.7733155737318977],
            ['2021-09-16', 1.7661953659616862],
            ['2021-09-17', 1.75552495625101],
            ['2021-09-20', 1.7073319409830758],
            ['2021-09-21', 1.7036755701399784],
            ['2021-09-22', 1.7353221001527805],
            ['2021-09-23', 1.7749324312405845],
            ['2021-09-24', 1.772300109946803],
        ],
        'cashWeight': 0,
        'rSquared': 0.8279135592848923,
        'annualizedReturn': 0.77299493701611,
        'annualizedVolatility': 0.19788814828229934,
        'hedgeRatio': 1,
        'ridgeWeight': 0,
        'backtestCorrelation': [
            ['2020-11-26', 0.9015925151077675],
            ...
            ['2020-12-08', 0.896541180905539],
            ['2020-12-09', 0.896342085151086],
            ...
            ['2021-03-12', 0.914739719013808],
            ['2021-03-15', 0.928463943323836],
            ...
            ['2021-07-07', 0.902025125731612],
            ['2021-07-08', 0.907076026609854],
            ...
            ['2021-07-30', 0.9176683013254561],
            ['2021-08-02', 0.92034668699813],
            ...
            ['2021-08-23', 0.9276585645717137],
            ['2021-08-24', 0.92856395669229],
            ['2021-08-25', 0.9271659353349381],
            ['2021-08-26', 0.9366798112705848],
            ['2021-08-27', 0.939469558627736],
            ['2021-08-30', 0.939741517191791],
            ...
            ['2021-09-09', 0.948472236169008],
            ['2021-09-10', 0.946294665243798],
            ['2021-09-13', 0.9452172483227433],
            ['2021-09-14', 0.9466756455002099],
            ['2021-09-15', 0.937395558117138],
            ['2021-09-16', 0.931622601567483],
        ...
        'trackingError': 0.09724809864706382,
        'lassoWeight': 0,
        'constituents': [
            {
                'country': 'United States',
                ...
                'transactionCost': 2.9051536321640015,
                'sector': 'Health Care',
                'correlation': 0.16678359890783784,
                'shares': -5.308036491917078,
                'assetId': 'MA4B66MW5E27UANZH4M',
                'bbid': 'XRAY UW',
                'currency': 'USD',
                'industry': 'Health Care Equipment & Supplies',
                'marginalCost': 0.03895858954426313,
                'advPercentage': 5e-06,
                'notional': -318.5352698799438,
                'price': 60.01,
            ...
            },
            {
                ...
                'transactionCost': 3.9990124702453613,
                'sector': 'Real Estate',
                'correlation': 0.06540203064772898,
                'shares': -3.1030213327842304,
                'assetId': 'MA4B66MW5E27UAFU2CS',
                'bbid': 'EXR UN',
                'currency': 'USD',
                'industry': 'Equity Real Estate Investment Trusts (REITs)',
                'marginalCost': 0.09017373674086719,
                'advPercentage': 5e-06,
                'notional': -535.6125122518861,
                'price': 172.61,
            ...
            },
            {
                ...
                'transactionCost': 1.2731897830963135,
                'sector': 'Consumer Staples',
                'correlation': 0.12350867819558603,
                'shares': -1.730011893560012,
                'assetId': 'MA4B66MW5E27UAKNZNV',
                'bbid': 'KR UN',
                'currency': 'USD',
                'industry': 'Food & Staples Retailing',
                'marginalCost': 0.003707333181127408,
                'advPercentage': 0,
                'notional': -69.16587550452927,
                'price': 39.98,
                'weight': 0.002911846474381391,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 7.908167362213135,
                'sector': 'Financials',
                'correlation': 0.24284241634131032,
                'shares': -0.5740039461869635,
                'assetId': 'MA4B66MW5E27UAL9SUH',
                'bbid': 'MSCI UN',
                'currency': 'USD',
                'industry': 'Capital Markets',
                'marginalCost': 0.1263897386589486,
                'advPercentage': 2e-06,
                'notional': -379.628989889672,
                'price': 661.37,
                'weight': 0.01598217802810611,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.0103281140327454,
                'sector': 'Consumer Discretionary',
                'correlation': 0.5028570129890573,
                'shares': -3.0290208240423557,
                'assetId': 'MA4B66MW5E27UAGYYVE',
                'bbid': 'GM UN',
                'currency': 'USD',
                'industry': 'Automobiles',
                'marginalCost': 0.006729167173415375,
                'advPercentage': 0,
                'notional': -158.20575763973224,
                'price': 52.23,
                'weight': 0.0066603780296242265,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 2.1279181241989136,
                'sector': 'Materials',
                'correlation': 0.6130275473664366,
                'shares': -5.192035694429817,
                'assetId': 'MA4B66MW5E27UAL9SLW',
                'bbid': 'MOS UN',
                'currency': 'USD',
                'industry': 'Chemicals',
                'marginalCost': 0.016679363095866095,
                'advPercentage': 2e-06,
                'notional': -186.18640000225324,
                'price': 35.86,
                'weight': 0.007838348151738823,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 0.8238705992698669,
                'sector': 'Communication Services',
                'correlation': 0.12666374147291945,
                'shares': -0.7130049017966985,
                'assetId': 'MA4B66MW5E3VLSECN',
                'bbid': 'FB UW',
                'currency': 'USD',
                'industry': 'Interactive Media & Services',
                'marginalCost': 0.008728781169081446,
                'advPercentage': 0,
                'notional': -251.6622101381627,
                'price': 352.96,
                'weight': 0.010594844841917037,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.2658634781837463,
                'sector': 'Communication Services',
                'correlation': 0.15422853187220908,
                'shares': -8.874061007775461,
                'assetId': 'MA4B66MW5E27UANLXU9',
                'bbid': 'TWTR UN',
                'currency': 'USD',
                'industry': 'Interactive Media & Services',
                'marginalCost': 0.03178955019863404,
                'advPercentage': 1e-06,
                'notional': -596.5143809426665,
                'price': 67.22,
                'weight': 0.025112937332109075,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.4358487129211426,
                'sector': 'Information Technology',
                'correlation': 0.22583565660778615,
                'shares': -0.5480037674398188,
                'assetId': 'MA4B66MW5E27UAM94N9',
                'bbid': 'PYPL UW',
                'currency': 'USD',
                'industry': 'IT Services',
                'marginalCost': 0.009212668138339708,
                'advPercentage': 0,
                'notional': -152.40532776268802,
                'price': 278.11,
                'weight': 0.006416183025018788,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.4352393746376038,
                'sector': 'Consumer Staples',
                'correlation': -0.03313295634963935,
                'shares': -11.239077266890737,
                'assetId': 'MA4B66MW5E27UAJ5XEZ',
                'bbid': 'HRL UN',
                'currency': 'USD',
                'industry': 'Food Products',
                'marginalCost': 0.027707143568185242,
                'advPercentage': 4e-06,
                'notional': -458.55435248914205,
                'price': 40.8,
                'weight': 0.019304893704704323,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 3.182479500770569,
                'sector': 'Materials',
                'correlation': 0.556129972455637,
                'shares': -0.7970054792874738,
                'assetId': 'MA4B66MW5E27UALNB48',
                'bbid': 'NUE UN',
                'currency': 'USD',
                'industry': 'Metals & Mining',
                'marginalCost': 0.010776575069254387,
                'advPercentage': 0,
                'notional': -80.43379296969185,
                'price': 100.92,
                'weight': 0.0033862197907779373,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.3822112533240394,
                'sector': 'Financials',
                'correlation': 0.6178643696685713,
                'shares': -43.79430107894055,
                'assetId': 'MA4B66MW5E27UANT8X5',
                'bbid': 'WFC UN',
                'currency': 'USD',
                'industry': 'Banks',
                'marginalCost': 0.12211961551022109,
                'advPercentage': 2e-06,
                'notional': -2098.622907702831,
                'price': 47.92,
                'weight': 0.0883509052733721,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 3.3661617040634155,
                'sector': 'Industrials',
                'correlation': 0.6412824675287682,
                'shares': -0.4130028393296445,
                'assetId': 'MA4B66MW5E27UACX6RZ',
                'bbid': 'CMI UN',
                'currency': 'USD',
                'industry': 'Machinery',
                'marginalCost': 0.013324512800464238,
                'advPercentage': 0,
                'notional': -94.02422640178686,
                'price': 227.66,
                'weight': 0.003958369790845086,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.2586397729172192,
                'sector': 'Financials',
                'correlation': 0.8505015474586123,
                'shares': -12.604086651115832,
                'assetId': 'MA4B66MW5E27UAKHZFD',
                'bbid': 'JPM UN',
                'currency': 'USD',
                'industry': 'Banks',
                'marginalCost': 0.10888889555559653,
                'advPercentage': 1e-06,
                'notional': -2054.970287597925,
                'price': 163.04,
                'weight': 0.08651315324576048,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 3.95284104347229,
                'sector': 'Communication Services',
                'correlation': 0.35956668091011157,
                'shares': -11.81608123370237,
                'assetId': 'MAQQM1QHGJDFAVKN',
                'bbid': 'LUMN UN',
                'currency': 'USD',
            ...
            },
            {
                ...
                'transactionCost': 0.5830498039722443,
                'sector': 'Information Technology',
                'correlation': 0.12884947696795268,
                'shares': -0.8120055824108264,
                'assetId': 'MA4B66MW5E27U9YGMB9',
                'bbid': 'AMD UW',
                'currency': 'USD',
            ...
            },
            {
                ...
                'transactionCost': 2.3784881788491172,
                'sector': 'Financials',
                'correlation': 0.9121008220093567,
                'shares': -100.16368860962515,
                'assetId': 'MA4B66MW5E27UAL9STW',
                'bbid': 'MS UN',
                'currency': 'USD',
                'industry': 'Capital Markets',
                'marginalCost': 1.0321563281719852,
                'advPercentage': 1.6e-05,
                'notional': -10307.845194816524,
                'price': 102.91,
                'weight': 0.43395478579650393,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.4510516652072596,
                'sector': 'Financials',
                'correlation': 0.8189307897328992,
                'shares': -27.227187182634943,
                'assetId': 'MA4B66MW5E27UA4ZCWT',
                'bbid': 'C UN',
                'currency': 'USD',
                'industry': 'Banks',
                'marginalCost': 0.11839142047698586,
                'advPercentage': 2e-06,
                'notional': -1938.0311836599553,
                'price': 71.18,
                'weight': 0.08159007933054924,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.3627572059631348,
                'sector': 'Real Estate',
                'correlation': 0.1248871579141672,
                'shares': -8.864060939026558,
                'assetId': 'MA4B66MW5E27UAEP46J',
                'bbid': 'DRE UN',
                'currency': 'USD',
                'industry': 'Equity Real Estate Investment Trusts (REITs)',
                'marginalCost': 0.02484233322743233,
                'advPercentage': 5e-06,
                'notional': -433.0093768714474,
                'price': 48.85,
                'weight': 0.0182294638536693,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 2.1669615507125854,
                'sector': 'Communication Services',
                'correlation': 0.18457789391303997,
                'shares': -6.899047429867354,
                'assetId': 'MA4B66MW5E27UAEP4H9',
                'bbid': 'EA UW',
                'currency': 'USD',
                'industry': 'Entertainment',
                'marginalCost': 0.08175721364539484,
                'advPercentage': 3e-06,
                'notional': -896.1862611397693,
                'price': 129.9,
                'weight': 0.037728963681201336,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 1.0424676537513733,
                'sector': 'Information Technology',
                'correlation': 0.37498752971441385,
                'shares': -0.6250042968063627,
                'assetId': 'MA4B66MW5E27UAM94Q4',
                'bbid': 'QCOM UW',
                'currency': 'USD',
                'industry': 'Semiconductors & Semiconductor Equipment',
                'marginalCost': 0.0036722977768481185,
                'advPercentage': 0,
                'notional': -83.67557525643583,
                'price': 133.88,
                'weight': 0.00352269709629183,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 5.661775350570679,
                'sector': 'Materials',
                'correlation': 0.572692690460937,
                'shares': -2.9210200815542167,
                'assetId': 'MA4B66MW5E27U9XPVYM',
                'bbid': 'ALB UN',
                'currency': 'USD',
                'industry': 'Chemicals',
                'marginalCost': 0.157630478243818,
                'advPercentage': 2e-06,
                'notional': -661.3189464638747,
                'price': 226.4,
                'weight': 0.027841174981965627,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 3.904104232788086,
                'sector': 'Consumer Discretionary',
                'correlation': 0.07218103540747003,
                'shares': -0.49000336869618827,
                'assetId': 'MA4B66MW5E27UANEQ5C',
                'bbid': 'TSCO UW',
                'currency': 'USD',
                'industry': 'Specialty Retail',
                'marginalCost': 0.016970819801319783,
                'advPercentage': 1e-06,
                'notional': -103.2535098516608,
                'price': 210.72,
                'weight': 0.004346917702348384,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 3.084942579269409,
                'sector': 'Health Care',
                'correlation': 0.20287653627709595,
                'shares': -3.4880239796169494,
                'assetId': 'MA4B66MW5E27UAEP4D8',
                'bbid': 'DVA UN',
                'currency': 'USD',
                'industry': 'Health Care Providers & Services',
                'marginalCost': 0.05481362341943657,
                'advPercentage': 6e-06,
                'notional': -422.05090153365086,
                'price': 121,
                'weight': 0.01776811788581744,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 2.754676938056946,
                'sector': 'Information Technology',
                'correlation': -0.014004050045478335,
                'shares': -2.204015152257958,
                'assetId': 'MA4B66MW5E27UAE4LLL',
                'bbid': 'CTXS UW',
                'currency': 'USD',
                'industry': 'Software',
                'marginalCost': 0.028164628476876532,
                'advPercentage': 2e-06,
                'notional': -242.86042962730437,
                'price': 110.19,
                'weight': 0.010224294576170117,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 2.401727557182312,
                'sector': 'Consumer Discretionary',
                'correlation': 0.45583415490693957,
                'shares': -4.535031177626968,
                'assetId': 'MA4B66MW5E27UA39J2L',
                'bbid': 'BBY UN',
                'currency': 'USD',
                'industry': 'Specialty Retail',
                'marginalCost': 0.04802785408186685,
                'advPercentage': 2e-06,
                'notional': -474.99916554464863,
                'price': 104.74,
                'weight': 0.019997211564750816,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'transactionCost': 2.417732357978821,
                'sector': 'Real Estate',
                'correlation': 0.4856832268445906,
                'shares': -5.0810349313170065,
                'assetId': 'MA4B66MW5E27UAJQF4M',
                'bbid': 'IRM UN',
                'currency': 'USD',
                'industry': 'Equity Real Estate Investment Trusts (REITs)',
                'marginalCost': 0.02289530957940409,
                'advPercentage': 3e-06,
                'notional': -224.93741640940388,
                'price': 44.27,
            ...
            },
            {
                ...
                'transactionCost': 2.314427137374878,
                'sector': 'Consumer Discretionary',
                'correlation': 0.6555947816398136,
                'shares': -7.397050853562664,
                'assetId': 'MAAHJ4JYCKZ6P025',
                'bbid': 'TPR UN',
                'currency': 'USD',
                'industry': 'Textiles, Apparel & Luxury Goods',
                'marginalCost': 0.02844040606854561,
                'advPercentage': 2e-06,
                'notional': -291.88762668158273,
                'price': 39.46,
        ...
        'holdingError': 0.0744447922751884,
    },
    'benchmarks': [],
    'target': {
        'annualizedVolatility': 0.2245953385486387,
        'backtestPerformance': [
            ['2020-09-24', 1],
            ['2020-09-25', 1.0076306394460186],
        ...
        'constituents': [
            {
                ...
                'currency': 'USD',
                'industry': 'Technology Hardware, Storage & Peripherals',
                'marginalCost': 0.19195231034013271,
                'advPercentage': 0,
                'notional': 3819.9199999999996,
                'price': 146.92,
                'weight': 0.16081659493619194,
                'borrowCost': 40,
            },
            {
                'country': 'United States',
                ...
                'currency': 'USD',
                'industry': 'Capital Markets',
                'marginalCost': 2.701680019005928,
                'advPercentage': 2.3e-05,
                'notional': 19933.350000000002,
                'price': 390.85,
                'weight': 0.8391834050638082,
                'borrowCost': 40,
            },
        ],
        'assetId': '',
        'transactionCost': 2.893632329346061,
        'annualizedReturn': 0.861701827815391,
    },
}

mock_results = {
    'Portfolio': {
        'Annualized Volatility': 0.2245953385486387,
        ...
        'Asset Id': '',
        'Transaction Cost': 2.893632329346061,
        'Annualized Return': 0.861701827815391,
    },
    'Hedge': {
        'Transaction Cost': 2.2604819652681694,
        'Correlation': 0.936758446681233,
        'Backtest Performance': [
            ['2020-09-24', 1],
            ['2020-09-25', 1.0104116399850593],
        ...
        'Cash Weight': 0,
        'R Squared': 0.8279135592848923,
        'Annualized Return': 0.77299493701611,
        'Annualized Volatility': 0.19788814828229934,
        'Hedge Ratio': 1,
        'Ridge Weight': 0,
    ...
    'Hedged Portfolio': {
        ...
        'Transaction Cost': 2.5770571473071144,
    },
}
...
def test_hedge_constraints_to_dict():
    constraints = HedgeConstraints(
        sectors=[Constraint(constraint_name='Software', minimum=0, maximum=20)],
        esg=[Constraint(constraint_name='gPercentile', minimum=75, maximum=100)],
    )
    assert constraints.to_dict() == {
        'classificationConstraints': [{'name': 'Software', 'min': 0, 'max': 20, 'type': 'Sector'}],
        'esgConstraints': [{'name': 'gPercentile', 'min': 75, 'max': 100}],
    }
...
def get_mock_hedge(mocker):
    ...
    hedge = PerformanceHedge(
        parameters=PerformanceHedgeParameters(
            initial_portfolio=PositionSet(
                positions=[Position(asset_id='fakeId', identifier='fakeId', quantity=1)], date=dt.date(2020, 1, 1)
            ),
            universe=[],
            exclusions=HedgeExclusions(),
            constraints=HedgeConstraints(),

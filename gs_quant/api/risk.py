...
CommodGama = RiskMeasure(measureType=RiskMeasureType.Gamma, assetClass=AssetClass.Commod)
...
FXGama = RiskMeasure(measureType=RiskMeasureType.Gamma, assetClass=AssetClass.FX)
...
IRGama = RiskMeasure(measureType=RiskMeasureType.Gamma, assetClass=AssetClass.Rates)

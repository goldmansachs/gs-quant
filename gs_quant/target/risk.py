...
class LiquidityConstituent(Base):
    ...
    def __init__(self, assetId: str = None, name: str = None, quantity: float = None, grossWeight: float = None, netWeight: float = None, currency: Union[Currency, str] = None, grossExposure: float = None, netExposure: float = None, adv22DayPct: float = None, transactionCost: float = None, marginalCost: float = None, bidAskSpread: float = None, country: str = None, region: Union[Region, str] = None, type: Union[AssetType, str] = None, marketCap: float = None, marketCapUSD: float = None, est1DayCompletePct: float = None, inRiskModel: bool = None, inCostPredictModel: bool = None, beta: float = None, dailyRisk: float = None, annualizedRisk: float = None, oneDayPriceChangePct: float = None, betaAdjustedExposure: float = None, advBucket=None, settlementDate: datetime.date = None):
        super().__init__()
        self.__assetId = assetId
        self.__name = name
...
class LiquiditySummarySection(Base):
    ...
    def __init__(self, adv10DayPct=None, adv22DayPct=None, adv5DayPct: float = None, annualizedRisk: float = None, annualizedTrackingError: float = None, beta: float = None, betaAdjustedExposure=None, bidAskSpread: float = None, correlation: float = None, dailyRisk: float = None, dailyTrackingError: float = None, est1DayCompletePct=None, grossExposure: float = None, marginalCost: float = None, marketCapUSD: float = None, minutesToTrade100Pct: float = None, netExposure: float = None, numberOfPositions=None, transactionCost: float = None):
        super().__init__()
...
class LiquiditySummary(Base):
    ...
    def __init__(self, total: LiquiditySummarySection, long: LiquiditySummarySection = None, short: LiquiditySummarySection = None):
        super().__init__()
        self.__total = total
        self.__long = long
        self.__short = short
...
class RiskRequest(Base):
    ...
    def __init__(self, positions: Tuple[RiskPosition, ...], measures: Tuple[RiskMeasure, ...], asOf: Union[datetime.datetime, datetime.date], pricingLocation: Union[PricingLocation, str] = 'NYC', marketDataAsOf: Union[datetime.datetime, datetime.date] = None, marketDataVendor: Union[MarketDataVendor, str] = 'Goldman Sachs', waitForResults: bool = False):
        super().__init__()
        self.__positions = positions
        self.__measures = measures
        self.__asOf = asOf
    ...
    @property
    def marketDataAsOf(self) -> Union[datetime.datetime, datetime.date]:
        """The date or time to source market data"""
        return self.__marketDataAsOf

    @marketDataAsOf.setter
    def marketDataAsOf(self, value: Union[datetime.datetime, datetime.date]):

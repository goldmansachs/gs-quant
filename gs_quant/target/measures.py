...
EqForwardSpot = RiskMeasure(name="EqForwardSpot", asset_class=AssetClass("Equity"), measure_type=RiskMeasureType("Forward Price"))
EqForwardSpot.__doc__ = "Equity Forward Spot"

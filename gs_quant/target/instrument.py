...
from gs_quant.base import get_enum_value, Instrument
...
class EqOption(Instrument):
    ...
    def __init__(self, asset: str, expirationDate: Union[datetime.date, str], strikePrice: Union[str, float], optionType: Union[OptionType, str], optionStyle: Union[OptionStyle, str], numberOfOptions: int = 1, exchange: str = None, multiplier: float = None, settlementDate: Union[datetime.date, str] = None, currency: Union[Currency, str] = None, premium: float = 0):
        super().__init__()
...
class FXOption(Instrument):
    ...
    def __init__(self, callCurrency: Union[Currency, str], putCurrency: Union[Currency, str], expirationDate: Union[datetime.date, str], optionType: Union[OptionType, str], callAmount: float = 1000000.0, putAmount: float = 1000000.0, strike: Union[str, float] = None, premium: float = 0):
        super().__init__()
